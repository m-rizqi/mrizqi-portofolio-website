...
<required_reading>
@D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/references/ai-frameworks.md
@D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/agents/gsd-eval-planner.md for instructions.
