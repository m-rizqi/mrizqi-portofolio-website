...
<!-- For checkpoint task examples and patterns, see @D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/references/checkpoints.md -->
...
See `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
