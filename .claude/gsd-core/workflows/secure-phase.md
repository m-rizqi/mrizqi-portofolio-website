...
```
Agent(
  prompt="Read D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/templates/SECURITY.md`
