...
<required_reading>
Read `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
