...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/.gsd-surface.json`
(sibling to `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/skills`).
...
`D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/.gsd-surface.json`
Install profile marker: `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/.gsd-profile`
Skill dirs: `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/skills/gsd-*/`
Engine module: `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
