...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude
                  → checks D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core
                  → writes to D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/hooks/
