...
Reference full template: `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/templates/state.md`.
