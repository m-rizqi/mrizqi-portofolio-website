...
export const PROJECTS: Project[] = [
  {
    ...
    summary:
      "Flutter driver application for a large-scale logistics and transportation ecosystem, integrated with backend services and Firebase Cloud Messaging for real-time operational notifications.",
  ...
  },
  {
    ...
    summary:
      "AI-powered document pipeline using OCR to automate invoice and receipt scanning, information extraction, and validation.",
  ...
  },
  {
    ...
    role: "Backend / AI Engineer",
    summary:
      "Telegram bot that assists support management teams by automating ticket categorization and generating AI-assisted responses.",
  ...
  },
  {
    ...
    summary:
      "Multiple ERP modules built on Spring Boot microservices with Next.js frontends, supporting operational and business workflows.",
  ...
  },
  {
    ...
    summary:
      "Android-based ticketing system deployed on TransJakarta buses, with local database migration and operator utility features.",
  ...
  },
  {
    ...
    summary:
      "Redesign and content management of the official Innovative Academy website, improving user experience, accessibility, and design consistency.",
  ...
  },
  {
    ...
    summary:
      "Flutter application providing airport information, flight schedules, and passenger services integrated with Angkasa Pura systems.",
  ...
  },
  {
    ...
    summary:
      "Educational Augmented Reality mobile application about traditional Indonesian houses, with AR experiences, quizzes, and user activity tracking.",
  ...
  },
  {
    ...
    summary:
      "Android application supporting IoT-based concrete cutting depth analysis for toll road infrastructure projects.",
  ...
  },
  {
    ...
    role: "Mobile Developer",
    summary:
      "Native Android application promoting children's mental health through interactive puzzle games.",
  ...
  },
  {
    ...
    role: "Android Developer",
    summary:
      "POS application for traditional grocery stores featuring barcode scanning, cashier functionality, inventory management, and Bluetooth receipt printing.",
  ...
  },
  {
    ...
    role: "Android Developer",
    summary:
      "Social reading platform enabling users to create, share, and discover short-form articles.",
...
export const CATEGORIES: string[] = ["All", "Mobile", "Backend", "AI", "Web"];
...
export const POSTS: Post[] = [
  {
    ...
    readTime: "8 min read",
    excerpt:
      "How I split a production Flutter app into data, domain, and presentation layers — and which parts of the theory I skip in real projects.",
    body: [
  ...
  },
  {
    ...
    excerpt:
      "Service boundaries, shared contracts, and the trade-offs I ran into while splitting enterprise modules into microservices.",
    body: [
  ...
  },
  {
    ...
    readTime: "7 min read",
    excerpt:
      "A practical pipeline for scanning documents, extracting fields, and validating results before anything reaches the database.",
    body: [
  ...
  },
  {
    ...
    readTime: "6 min read",
    excerpt:
      "What it takes to make push notifications dependable for drivers working in the field all day.",
    body: [
  ...
  },
  {
    ...
    readTime: "9 min read",
    excerpt:
      "Automating builds, signing, and distribution so releases stop depending on one laptop.",
    body: [
  ...
  },
  {
    ...
    excerpt:
      "Findings from my undergraduate research: building an Android app for UWB-based self-localization and real-time tracking.",
    body: [
...
export const TAGS: string[] = ["All", "Flutter", "Mobile", "Backend", "AI", "DevOps", "Research"];
