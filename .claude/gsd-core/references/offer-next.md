...
Read and follow `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
