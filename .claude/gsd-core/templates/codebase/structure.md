...
- Usage: Reference from command with `@D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
