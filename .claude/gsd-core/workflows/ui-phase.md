...
```markdown
Read D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/agents/gsd-ui-checker.md for instructions.
...
@D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
