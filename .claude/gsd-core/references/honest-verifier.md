...
`@D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/references/edge-probe.md` (which *classifies* non-inferable checks) and
`@D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/references/prohibition-probe.md` (whose judgment-tier disposition this mirrors).
