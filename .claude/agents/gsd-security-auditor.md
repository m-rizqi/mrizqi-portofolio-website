...
**Verification depth scales with `asvs_level`** (see @D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
