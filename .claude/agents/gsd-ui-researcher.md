...
Use template from `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/templates/UI-SPEC.md`
