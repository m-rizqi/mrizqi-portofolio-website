...
ones). Reference: @D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/gsd-core/templates/spec.md.
