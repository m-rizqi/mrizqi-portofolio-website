...
const masjidhub: Project = {
  ...
  goal: "Digitize mosque administration and give the public transparent, always-on access to prayer schedules, activities, and cash-flow reports. It's a B2B2C SaaS product mosque committees can run without touching a line of code.",
  problem:
