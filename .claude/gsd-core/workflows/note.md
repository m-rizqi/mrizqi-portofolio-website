...
- **Global scope**: `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/notes/`)
...
2. Glob `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Bisnis/25HoursLab/vibecoding-starter-kit/.claude/notes/` — works in any directory
